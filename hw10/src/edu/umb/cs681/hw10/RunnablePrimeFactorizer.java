...
public class RunnablePrimeFactorizer extends PrimeFactorizer implements Runnable {
	...
	public static void main(String[] args) {
		...
		runnables.add(new RunnablePrimeFactorizer(2489, 2, (long) Math.sqrt(2467) / 2));
		runnables.add(new RunnablePrimeFactorizer(2489, 1 + (long) Math.sqrt(2467) / 2, (long) Math.sqrt(2467)));
